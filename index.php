  ...
  <div id="main">
    ...
    <div id="site_content">
      ...
      <div id="content ul li">
        ...
        <h1>Blog ini dibuat untuk memenuhi tugas Sistem Temu Kembali Informasi</h1>
        <a href="http://kumanakaunisbank.blogspot.com/2017/10/makalah-tokenisasi-stopword-removal-dan_24.html">Link Makalah Dewi Rahayuni</a><br>
        <a href="http://blogerku12345.blogspot.co.id/2017/10/makalah-sistem-temu-kembali-informasi.html?m=1">Link Makalah Indriani</a><br>
        <a href="http://sitiadhazulianiunisbank.blogspot.co.id/2017/10/makalah-sistem-temu-kembali-informasi.html?=1">Link Makalah Siti Adha Zuliani</a>
        </ul>
      </div>
    </div>
